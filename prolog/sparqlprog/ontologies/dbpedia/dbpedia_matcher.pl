:- module(dbpedia_matcher,
          [band/1,
           has_shared_band_member/3,
           has_shared_genre/3,
           similarity_by_genre/3,
           jaccard/3,
           pair_genre_sum_ic/3]).
          
/** <module> perform entity matching/similarity using dbpedia

This module is intended primarily as an example of how to mix local logic and remote sparql logic.

  * similarity_by_genre/3 - compares two entities using jaccard similarity of genres
  * pair_genre_sum_ic/3 - alternate metric that uses information content of genres in common
