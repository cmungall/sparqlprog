...
:- sparql_endpoint( uniprot, 'https://sparql.uniprot.org/sparql').
...
:- sparql_endpoint( rhea, 'https://sparql.rhea-db.org/sparql').
:- sparql_endpoint( ubergraph, 'https://stars-app.renci.org/ubergraph/sparql').
:- sparql_endpoint( local, 'http://127.0.0.1:9999/blazegraph/sparql').
